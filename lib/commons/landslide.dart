...
class TextContent {
  Future<Map<String, dynamic>> loadContent() async {
    final String jsonContent =
        await rootBundle.loadString('assets/json/landslide.json');
            ...
            children: <Widget>[
              ...
              ListTile(
                title: Padding(
                  padding: EdgeInsets.only(left: 35.0),
                  child:
                      Text(_content?["overview"]["content"][0]["point7"] ?? ""),
                ),
                visualDensity: VisualDensity(vertical: -4),
              ),
              ListTile(
                title: Padding(
                  padding: EdgeInsets.only(left: 35.0),
                  child:
                      Text(_content?["overview"]["content"][0]["point8"] ?? ""),
                ),
                visualDensity: VisualDensity(vertical: -4),
              ),
              ListTile(
                title: Padding(
                  padding: EdgeInsets.only(left: 35.0),
                  child:
                      Text(_content?["overview"]["content"][0]["point9"] ?? ""),
                ),
                visualDensity: VisualDensity(vertical: -4),
              ),
            ],
