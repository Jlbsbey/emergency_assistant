...
class FireBuildingRUPage extends StatefulWidget {
  @override
  State<FireBuildingRUPage> createState() => _FireBuildingRUPageState();
}

class _FireBuildingRUPageState extends State<FireBuildingRUPage> {
