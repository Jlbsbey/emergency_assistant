...
class HurricaneRUPage extends StatefulWidget {
  @override
  State<HurricaneRUPage> createState() => _HurricaneRUPageState();
}

class _HurricaneRUPageState extends State<HurricaneRUPage> {
  @override
