...
class FloodRUPage extends StatefulWidget {
  @override
  State<FloodRUPage> createState() => _FloodRUPageState();
}

class _FloodRUPageState extends State<FloodRUPage> {
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Text(
                  ...
                  "•Узнайте и сохраните в своем мобильном телефоне и записной книжке номера телефонов, по которым следует звонить, чтобы сообщить о наводнении и получить помощь - номера телефонов самоуправления и аварийных служб.\n"
