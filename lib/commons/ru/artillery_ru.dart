...
class ArtilleryRUPage extends StatefulWidget {
  @override
  State<ArtilleryRUPage> createState() => _ArtilleryRUPageState();
}

class _ArtilleryRUPageState extends State<ArtilleryRUPage> {
