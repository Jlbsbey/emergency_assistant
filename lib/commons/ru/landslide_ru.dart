...
class LandslideRUPage extends StatefulWidget {
  @override
  State<LandslideRUPage> createState() => _LandslideRUPageState();
}

class _LandslideRUPageState extends State<LandslideRUPage> {
          ...
          const ExpansionTile(
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: ListTile(
                  title: Text('•Занесите в дом все вещи со двора или балкона.'),
                  visualDensity: VisualDensity(vertical: -4),
                ),
              ),
              Padding(
