          ...
          child: Column(children: <Widget>[
            ...
            Padding(
              ...
              child: Text(
                ...
                "•Как можно быстрее покиньте загрязнённое место, двигаясь перпендикулярно потоку ветра (так, чтобы ветер дул с боков).\n"
                "•Окажите помощь пострадавшим, но не возвращайтесь в загрязнённую територию.\n"
