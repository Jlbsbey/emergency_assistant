...
class LandslideENPage extends StatefulWidget {
  @override
  State<LandslideENPage> createState() => _LandslideENPageState();
}

class _LandslideENPageState extends State<LandslideENPage> {
            ...
            children: <Widget>[
              ...
              ListTile(
                title: Padding(
                  padding: EdgeInsets.only(left: 50.0),
                  child:
                      Text('•Let your neighbors know that disaster is coming.'),
                ),
                visualDensity: VisualDensity(vertical: -4),
              ),
              ListTile(
                title: Padding(
                  padding: EdgeInsets.only(left: 50.0),
                  child: Text('•Get out of the line of landslide immediately.'),
                ),
                visualDensity: VisualDensity(vertical: -4),
              ),
            ],
