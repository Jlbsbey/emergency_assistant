...
class OccupationENPage extends StatefulWidget {
  @override
  State<OccupationENPage> createState() => _OccupationENPageState();
}

class _OccupationENPageState extends State<OccupationENPage> {
