...
class ArtilleryENPage extends StatefulWidget {
  @override
  State<ArtilleryENPage> createState() => _ArtilleryENPageState();
}

class _ArtilleryENPageState extends State<ArtilleryENPage> {
