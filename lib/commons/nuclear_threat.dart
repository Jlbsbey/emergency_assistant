...
class NuclearPage extends StatefulWidget {
  @override
  State<NuclearPage> createState() => _NuclearPageState();
}

class TextContent {
  Future<Map<String, dynamic>> loadContent() async {
    final String jsonContent =
        await rootBundle.loadString('assets/json/nuclear.json');
    final data = await json.decode(jsonContent)[language];
    return data;
  }
}

class _NuclearPageState extends State<NuclearPage> {
